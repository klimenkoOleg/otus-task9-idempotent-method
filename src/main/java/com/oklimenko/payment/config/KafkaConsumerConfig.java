...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<Long, PaymentSystemEvent> newPaymentConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(PaymentSystemEvent.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, PaymentSystemEvent>
                newPaymentKafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<Long, PaymentSystemEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
